...
- There is another way to make it better
...
#### As you can see above, we end up using the <u>find()</u> method to take care of the listings

<br>

#### Now lets review this below one more time:

[<img src="./z_img-read/listing.gif"/>]()

<br>

#### In the next step we will be creating the page relating to the nft (the user will be reedirected there once the user clicks on the card)
